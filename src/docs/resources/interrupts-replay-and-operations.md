...
source: picoflow/src/picoflow/types/flow-types.ts, picoflow/src/picoflow/services/flow-engine.ts, pico-demo/src/myflow/hotel-langgraph/hotel-langgraph.ts
---
